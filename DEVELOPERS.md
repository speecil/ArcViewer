...
ArcViewer is developed with Unity **6000.0.67f1** in C#.
...
* Install unity version 6000.0.67f1 from within Unity Hub in the "Installs" section. This may not be the latest release; in this case, you should consult the "download archive" (from within Unity Hub). The installer will take care of the required dependencies as well.
